...
-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('ADMIN', 'MANAGER', 'EDITOR', 'SUPPORT', 'CUSTOMER');
...
-- CreateIndex
CREATE INDEX "PasswordResetToken_identifier_createdAt_idx" ON "PasswordResetToken"("identifier", "createdAt");

-- CreateIndex
CREATE INDEX "RolePermission_role_idx" ON "RolePermission"("role");

-- CreateIndex
CREATE UNIQUE INDEX "RolePermission_role_section_key" ON "RolePermission"("role", "section");
